...
echo -e "   ${CYAN}Edit docs/harness-v2/agents/[terminal-name].md${NC}"
echo ""
echo -e "${PURPLE}📚 Documentation:${NC}"
echo -e "   ${CYAN}docs/harness-v2/README-v3-8terminal.md${NC} - System overview"
echo -e "   ${CYAN}docs/harness-v2/workflows/tdd-coordination.md${NC} - TDD workflows"
